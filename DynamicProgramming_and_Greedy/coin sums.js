...
var change = function(total) {
  ...
  } // for example consider amount 5 in dp table.  When i = 0 (coin is 1), all values in dp will be 1 (only 1 way to make amount with only 1).  At i=1(coin=2), dp[5] = dp[5] + dp[5-2] = 3.  At i=2(coin=5), dp[5] = dp[0] + dp[3] = 4
